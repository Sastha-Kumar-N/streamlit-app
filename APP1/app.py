...
st.set_page_config(page_title="Introduction to Python for Biologists", layout="wide")
...
modules = {
    "Start": None,
    "Module 1: Basics": {"Introduction": None, " File Handelling": None, "AI in Genomics": None},
...
st.markdown("""
    ...
    <h1 class="heading">📖 Welcome to Introduction to Python for Biologists</h1>
""", unsafe_allow_html=True)
...
if not selected_topic:
    ...
    if selected_module == "Module 1: Basics":
        ...
        elif selected_topic == " File Handelling":
            st.video("https://youtu.be/ApWYRPbPWB4")
